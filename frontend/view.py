    ...
    [
        ...
        html.Div(
            [
                html.Div(
                    [
                        html.H4("АНАЛИЗ СЕТЕВОГО ТРАФИКА", className="app__header__title"),
                        html.P(
                            "Это приложение проводит анализ сетевого трафика проходящего через ваше устройство.",
                ...
                html.Div(
                    [
                        html.A(
                            html.Button("ИСХОДНЫЙ КОД", className="link-button"),
                            href="https://github.com/Yan-Minotskiy/B-B",
                        ),
        ...
        html.Div(
            [
                ...
                html.Div(
                    [
                        html.Div(
                            [html.H6("СКОРОСТЬ ВХОДЯЩЕГО ТРАФИКА (БИТ/СЕК.)", className="graph__title")]
                        ),
                        dcc.Graph(
                            id="wind-speed",
                            figure=dict(
                                ...
                                html.Div(
                                    [
                                        dcc.Checklist(
                                            id="bin-auto",
                                            options=[
                                                {"label": "По умолчанию (20 мин.)", "value": "Auto"}
                                            ],
                                            value=["Auto"],
                        ...
                        html.Div(
                            [
                                html.Div(
                                    [
                                        html.H6(
                                            "НАПРАВЛЕНИЕ ТРАФИКА", className="graph__title"
                                        )
                                    ]
                                ),
                                dcc.Graph(
